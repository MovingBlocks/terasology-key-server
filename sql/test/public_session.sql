...
PREPARE get_result AS SELECT (get_session(NULL, '42d05511-8786-404a-8bfe-f0f74975b985'::UUID))->>'login';
...
SELECT delete_session(NULL, 'bc32a32f-e977-4351-90ee-1a470135917d'::UUID);
