...
GRANT EXECUTE ON FUNCTION post_user_account(JSON, TEXT) TO terasologykeys_app;
GRANT EXECUTE ON FUNCTION delete_user_account(JSON, TEXT) TO terasologykeys_app;
